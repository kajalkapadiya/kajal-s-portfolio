  ...
  return (
    <div className="fixed left-4 bottom-4 flex items-center justify-center overflow-hidden md:right-8 md:left-auto md:top-0 md:bottom-auto">
      <div className="w-48 h-auto flex items-center justify-center relative md:w-24">
        <HireMeLogo className={"fill-dark animate-spin-slow dark:fill-white"} />
        <Link
         ...
         bg-dark text-light shadow-md border border-solid border-dark w-20 h-20
          ...
          dark:text-dark dark:bg-light hover:dark:bg-dark hover:dark:text-light hover:dark:border-light md:w-12 md:h-12 md:text-[10px]"
        >
          Hire Me
        </Link>
      </div>
